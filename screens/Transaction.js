...
export default class TransactionScreen extends Component{
  constructor(props){
    ...
    getCameraPermissions = async domState =>{
      ...
      this.setState({
        /* status === "garanted" é verdadeiro se o usuário concedeu permissão"
           status === "garanted" é falso se o usuario não concedeu a permissão*/
            hasCameraPermissions: status ==="garanted",
            domState:domState,
            scanned:false
      });
    };
